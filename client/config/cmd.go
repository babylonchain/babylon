...
// config file.
// adapted from https://github.com/cosmos/cosmos-sdk/blob/6d32debf1aca4b7f1ed1429d87be1d02c315f02d/client/config/cmd.go
...
func runConfigCmd(cmd *cobra.Command, args []string) error {
	...
	case 1:
		...
		case flags.FlagFrom:
			cmd.Println(conf.FromName)
		default:
			err := errUnknownConfigKey(key)
			return fmt.Errorf("could not get the value for the key: %v, error:  %v", key, err)
		}
