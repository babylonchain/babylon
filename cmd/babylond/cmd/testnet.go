...
Example:
	...
	cmd.Flags().String(server.FlagMinGasPrices, "0.000006bbn", "Minimum gas prices to accept for transactions; All fees in a tx must meet this minimum (e.g. 0.01photino,0.001stake)")
