...
// BuildPoP builds a proof-of-possession by encrypt(key = BLS_sk, data = encrypt(key = Ed25519_sk, data = BLS_sk))
// where valPrivKey is Ed25519_sk, blsPrivkey is BLS_sk
