...
var (
	...
	ErrHeaderHigherThanTip      = sdkerrors.Register(ModuleName, 1104, "header is higher than the tip")
	ErrEmptyMessage             = sdkerrors.Register(ModuleName, 1105, "empty message provided")
)
