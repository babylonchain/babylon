...
type MsgInsertHeader struct {
	...
	HeaderBytes *BTCHeaderBytes `protobuf:"bytes,2,opt,name=header_bytes,json=headerBytes,proto3" json:"header_bytes,omitempty"`
}
...
func (m *MsgInsertHeader) GetHeaderBytes() *BTCHeaderBytes {
	if m != nil {
...
var fileDescriptor_84e67479ce863198 = []byte{
	...
	0xf4, 0xca, 0x0c, 0xa5, 0xb4, 0x71, 0xe8, 0x45, 0x53, 0x09, 0x36, 0x47, 0xa9, 0x9c, 0x8b, 0xdf,
	...
	,
}
...
func (m *MsgInsertHeader) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.HeaderBytes != nil {
		{
			size, err := m.HeaderBytes.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MsgInsertHeader) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.HeaderBytes == nil {
				m.HeaderBytes = &BTCHeaderBytes{}
			}
			if err := m.HeaderBytes.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
