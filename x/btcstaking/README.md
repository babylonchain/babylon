...
- **BTC staker (aka delegator)** who delegates their Bitcoins to a Finality
  provider to obtain staking rewards.
...
2. A BTC staker delegates some Bitcoins to the Finality provider.
...
existing Finality provider, including the commission and the description.
It needs to be submitted by using the Babylon account registered in the Finality
provider.
