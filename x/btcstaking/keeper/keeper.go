...
// iterates over all BTC delegations under non-slashed finality providers to:
// 1) Record the voting power table for the current height, and
// 2) record the voting power distribution cache used for computing voting power table
