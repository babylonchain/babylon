...
type FinalityProviderWithMeta struct {
	...
	// master_pubrand is the master public randomness of the finality provider
	MasterPubrand []byte `protobuf:"bytes,4,opt,name=master_pubrand,json=masterPubrand,proto3" json:"master_pubrand,omitempty"`
	// slashed_babylon_height indicates the Babylon height when
	// the finality provider is slashed.
	// if it's 0 then the finality provider is not slashed
...
func (m *FinalityProviderWithMeta) GetMasterPubrand() []byte {
	if m != nil {
		return m.MasterPubrand
	}
	return nil
...
var fileDescriptor_3851ae95ccfaf7db = []byte{
	...
	,
}
...
func (m *FinalityProviderWithMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.MasterPubrand = append(m.MasterPubrand[:0], dAtA[iNdEx:postIndex]...)
			if m.MasterPubrand == nil {
				m.MasterPubrand = []byte{}
			}
			iNdEx = postIndex
		case 5:
			if wireType != 0 {
