...
type BTCDelegations struct {
	Dels []*BTCDelegation `protobuf:"bytes,1,rep,name=dels,proto3" json:"dels,omitempty"`
}

func (m *BTCDelegations) Reset()         { *m = BTCDelegations{} }
func (m *BTCDelegations) String() string { return proto.CompactTextString(m) }
func (*BTCDelegations) ProtoMessage()    {}
func (*BTCDelegations) Descriptor() ([]byte, []int) {
	return fileDescriptor_3851ae95ccfaf7db, []int{3}
}
func (m *BTCDelegations) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BTCDelegations) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BTCDelegations.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BTCDelegations) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BTCDelegations.Merge(m, src)
}
func (m *BTCDelegations) XXX_Size() int {
	return m.Size()
}
func (m *BTCDelegations) XXX_DiscardUnknown() {
	xxx_messageInfo_BTCDelegations.DiscardUnknown(m)
}

var xxx_messageInfo_BTCDelegations proto.InternalMessageInfo

func (m *BTCDelegations) GetDels() []*BTCDelegation {
	if m != nil {
		return m.Dels
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*BTCDelegations)(nil), "babylon.btcstaking.v1.BTCDelegations")
...
var fileDescriptor_3851ae95ccfaf7db = []byte{
	...
	0x14, 0x8e, 0xdd, 0x34, 0x3f, 0x9e, 0xd3, 0x2a, 0x1d, 0x4a, 0x15, 0x15, 0x91, 0xa4, 0x11, 0xa0,
	0x08, 0x21, 0x9b, 0xa6, 0x3f, 0xc4, 0x0f, 0x09, 0x84, 0xdb, 0x08, 0x02, 0xb4, 0x58, 0x76, 0x54,
	...
	,
}
...
func (m *BTCDelegations) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BTCDelegations) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BTCDelegations) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BTCDelegations) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BTCDelegations) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BTCDelegations: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BTCDelegations: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
