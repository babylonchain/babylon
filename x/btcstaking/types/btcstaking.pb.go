...
type FinalityProvider struct {
	...
	// A finality provider is activated if it is
	// if it's 0 then the finality provider is not activated,
	// and the value will be updated if it enters the active
	// set again
...
func (m *FinalityProvider) GetActivatedBabylonHeight() uint64 {
	if m != nil {
...
var fileDescriptor_3851ae95ccfaf7db = []byte{
	...
	,
}
...
func (m *FinalityProvider) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ActivatedBabylonHeight != 0 {
		i = encodeVarintBtcstaking(dAtA, i, uint64(m.ActivatedBabylonHeight))
		i--
		dAtA[i] = 0x50
	}
...
func (m *FinalityProvider) Size() (n int) {
	...
	if m.ActivatedBabylonHeight != 0 {
		n += 1 + sovBtcstaking(uint64(m.ActivatedBabylonHeight))
	}
	if m.Jailed {
		n += 2
	}
