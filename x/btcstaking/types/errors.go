...
var (
	...
	ErrEmptyValidatorList       = errorsmod.Register(ModuleName, 1117, "the validator list is empty")
	ErrInvalidProofOfPossession = errorsmod.Register(ModuleName, 1118, "the proof of possession is not valid")
	ErrDuplicatedValidator      = errorsmod.Register(ModuleName, 1119, "the staking request contains duplicated validator public key")
)
