...
type Params struct {
	...
	// the address is on Bitcoin
	SlashingAddress []byte `protobuf:"bytes,2,opt,name=slashing_address,json=slashingAddress,proto3" json:"slashing_address,omitempty"`
}
...
func (m *Params) GetSlashingAddress() []byte {
	if m != nil {
...
var fileDescriptor_8d1392776a3e15b9 = []byte{
	...
	0x49, 0x29, 0x4a, 0x2d, 0x2e, 0x96, 0x60, 0x02, 0x99, 0x1c, 0xc4, 0x0f, 0x13, 0x77, 0x84, 0x08,
	0x5b, 0xb1, 0xcc, 0x58, 0x20, 0xcf, 0xe0, 0xe4, 0x73, 0xe2, 0x91, 0x1c, 0xe3, 0x85, 0x47, 0x72,
	0x8c, 0x0f, 0x1e, 0xc9, 0x31, 0x4e, 0x78, 0x2c, 0xc7, 0x70, 0xe1, 0xb1, 0x1c, 0xc3, 0x8d, 0xc7,
	0x72, 0x0c, 0x51, 0x04, 0x9d, 0x51, 0x81, 0x1c, 0x22, 0x60, 0x37, 0x25, 0xb1, 0x81, 0x7d, 0x68,
	0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xba, 0xda, 0xfc, 0xdc, 0x34, 0x01, 0x00, 0x00,
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.SlashingAddress = append(m.SlashingAddress[:0], dAtA[iNdEx:postIndex]...)
			if m.SlashingAddress == nil {
				m.SlashingAddress = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
