...
type QueryBTCValidatorPowerAtHeightResponse struct {
	...
	// it will be used for the BTC validator program to generate finality signatures
	LastCommitHash []byte `protobuf:"bytes,1,opt,name=last_commit_hash,json=lastCommitHash,proto3" json:"last_commit_hash,omitempty"`
...
func (m *QueryBTCValidatorPowerAtHeightResponse) GetLastCommitHash() []byte {
	if m != nil {
...
type QueryBTCValidatorCurrentPowerResponse struct {
	...
	// last_commit_hash is the last commit hash of the block at the current height
	// it will be used for the BTC validator program to generate finality signatures
...
func (m *QueryBTCValidatorCurrentPowerResponse) GetLastCommitHash() []byte {
	if m != nil {
		return m.LastCommitHash
	}
	return nil
...
var fileDescriptor_74d49d26f7429697 = []byte{
	...
	,
}
...
func (m *QueryBTCValidatorPowerAtHeightResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LastCommitHash) > 0 {
		...
		i = encodeVarintQuery(dAtA, i, uint64(len(m.LastCommitHash)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
