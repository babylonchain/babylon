...
type QueryBTCValidatorDelegationsResponse struct {
	// btc_delegations contains all the queried BTC delegations.
	BtcDelegations []*BTCDelegations `protobuf:"bytes,1,rep,name=btc_delegations,json=btcDelegations,proto3" json:"btc_delegations,omitempty"`
	// pagination defines the pagination in the response.
	Pagination *query.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}
...
func (m *QueryBTCValidatorDelegationsResponse) GetBtcDelegations() []*BTCDelegations {
	if m != nil {
		return m.BtcDelegations
	}
	return nil
...
var fileDescriptor_74d49d26f7429697 = []byte{
	...
	,
}
...
func (m *QueryBTCValidatorDelegationsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.BtcDelegations = append(m.BtcDelegations, &BTCDelegations{})
			if err := m.BtcDelegations[len(m.BtcDelegations)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
