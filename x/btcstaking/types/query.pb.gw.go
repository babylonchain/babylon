...
var (
	...
	pattern_Query_BTCValidatorPowerAtHeight_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5, 2, 6, 1, 0, 4, 1, 5, 7}, []string{"babylonchain", "babylon", "btcstaking", "v1", "btc_validators", "val_btc_pk_hex", "power", "height"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ActivatedHeight_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"babylonchain", "babylon", "btcstaking", "v1", "activated_height"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BTCValidatorDelegations_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5, 2, 6}, []string{"babylonchain", "babylon", "btcstaking", "v1", "btc_validators", "val_btc_pk_hex", "delegations"}, "", runtime.AssumeColonVerbOpt(false)))
)
