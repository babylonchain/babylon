...
var (
	...
	ErrBlsKeyDoesNotExist   = sdkerrors.Register(ModuleName, 1207, "BLS public key does not exist")
	ErrBlsKeyAlreadyExist   = sdkerrors.Register(ModuleName, 1208, "BLS public key already exists")
)
