...
var (
	...
	ErrInvalidBlsSignature    = sdkerrors.Register(ModuleName, 1212, "BLS signature is invalid")
	ErrConflictingCheckpoint  = sdkerrors.Register(ModuleName, 1213, "Conflicting checkpoint is found")
	ErrInvalidLastCommitHash  = sdkerrors.Register(ModuleName, 1214, "Provided last commit hash is Invalid")
)
