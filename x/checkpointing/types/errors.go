...
var (
	...
	ErrBlsKeyDoesNotExist  = sdkerrors.Register(ModuleName, 1205, "BLS public key does not exist")
	ErrBlsKeyAlreadyExist  = sdkerrors.Register(ModuleName, 1206, "BLS public key already exists")
)
