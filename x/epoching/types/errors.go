...
var (
	ErrUnwrappedMsgType          = sdkerrors.Register(ModuleName, 1, "invalid message type in {MsgWrappedCreateValidator, MsgDelegate, MsgUndelegate, MsgBeginRedelegate} messages. use wrapped versions instead")
