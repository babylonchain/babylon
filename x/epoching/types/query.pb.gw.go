...
var (
	...
	pattern_Query_EpochMsgs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"babylon", "epoching", "v1", "epoch_msgs"}, "", runtime.AssumeColonVerbOpt(false)))
)
