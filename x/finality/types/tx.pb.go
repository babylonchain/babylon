...
type MsgAddFinalitySig struct {
	...
	FpBtcPk []byte `protobuf:"bytes,2,opt,name=fp_btc_pk,json=fpBtcPk,proto3" json:"fp_btc_pk,omitempty"`
...
func (m *MsgAddFinalitySig) GetFpBtcPk() []byte {
	if m != nil {
		return m.FpBtcPk
	}
	return nil
...
func (m *MsgCommitPubRandList) GetFpBtcPk() []byte {
	if m != nil {
		return m.FpBtcPk
	}
	return nil
...
var fileDescriptor_2dd6da066b6baf1d = []byte{
	...
	,
}
...
func (m *MsgAddFinalitySig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FpBtcPk) > 0 {
		i -= len(m.FpBtcPk)
		copy(dAtA[i:], m.FpBtcPk)
		i = encodeVarintTx(dAtA, i, uint64(len(m.FpBtcPk)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Signer) > 0 {
...
func (m *MsgAddFinalitySig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.FpBtcPk = append(m.FpBtcPk[:0], dAtA[iNdEx:postIndex]...)
			if m.FpBtcPk == nil {
				m.FpBtcPk = []byte{}
			}
			iNdEx = postIndex
