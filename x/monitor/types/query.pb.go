...
type QueryReportedCheckpointBtcHeightRequest struct {
	CkptHash []byte `protobuf:"bytes,1,opt,name=ckpt_hash,json=ckptHash,proto3" json:"ckpt_hash,omitempty"`
}
...
func (m *QueryReportedCheckpointBtcHeightRequest) GetCkptHash() []byte {
	if m != nil {
		return m.CkptHash
	}
	return nil
...
var fileDescriptor_3b70877a7534d1c4 = []byte{
	...
	,
}
...
func (m *QueryReportedCheckpointBtcHeightRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.CkptHash = append(m.CkptHash[:0], dAtA[iNdEx:postIndex]...)
			if m.CkptHash == nil {
				m.CkptHash = []byte{}
			}
			iNdEx = postIndex
