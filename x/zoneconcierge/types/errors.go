...
var (
	...
	ErrChainInfoNotFound     = sdkerrors.Register(ModuleName, 1103, "chain does not exist")
	ErrReInitChainInfo       = sdkerrors.Register(ModuleName, 1104, "chain info has already been initialized")
	ErrHeaderNotFound        = sdkerrors.Register(ModuleName, 1105, "no header exists at this height")
	ErrNoValidAncestorHeader = sdkerrors.Register(ModuleName, 1106, "no valid ancestor for this header")
	ErrForkNotFound          = sdkerrors.Register(ModuleName, 1107, "cannot find fork")
)
