...
func (m *DigestItem) Decode(decoder Decoder) error {
...
func (m DigestItem) Encode(encoder Encoder) error {
	var err1, err2 error
	switch {
	case m.IsOther:
...
func (c ChangesTrieSignal) Encode(encoder Encoder) error {
	switch {
...
func (c *ChangesTrieSignal) Decode(decoder Decoder) error {
