...
func (i *I128) Decode(decoder Decoder) error {
	bs := make([]byte, 16)
	err := decoder.Read(bs)
	if err != nil {
		return err
...
func (i I128) Encode(encoder Encoder) error {
...
// Decode implements decoding as per the Scale specification
func (i *I256) Decode(decoder Decoder) error {
	bs := make([]byte, 32)
	err := decoder.Read(bs)
	if err != nil {
		return err
...
// Encode implements encoding as per the Scale specification
func (i I256) Encode(encoder Encoder) error {
