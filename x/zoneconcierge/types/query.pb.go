...
import (
	context "context"
	fmt "fmt"
	_ "github.com/babylonchain/babylon/x/btccheckpoint/types"
	_ "github.com/babylonchain/babylon/x/checkpointing/types"
...
type QueryFinalizedChainInfoResponse struct {
	...
	Proof *ProofFinalizedChainInfo `protobuf:"bytes,2,opt,name=proof,proto3" json:"proof,omitempty"`
}
...
var fileDescriptor_2caab7ee15063236 = []byte{
	...
	,
}
