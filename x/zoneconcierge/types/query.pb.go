...
type QueryFinalizedChainInfoResponse struct {
	...
	// next_validator_set is the validator set of the next epoch
	// This allows to verify the epoch has sealed by the following verification rules:
	// - >1/3 validators in next_validator_set have generated a BLS signature over LastCommitHash of the epoch's last block, AND
	// - next_validator_set matches NextValidatorsHash of the epoch's last block
	NextValidatorSet []*types1.ValidatorWithBlsKey `protobuf:"bytes,7,rep,name=next_validator_set,json=nextValidatorSet,proto3" json:"next_validator_set,omitempty"`
	// proof_epoch_submitted is the proof that the epoch's checkpoint is included in BTC ledger
	ProofEpochSubmitted *types2.BTCSpvProof `protobuf:"bytes,8,opt,name=proof_epoch_submitted,json=proofEpochSubmitted,proto3" json:"proof_epoch_submitted,omitempty"`
}
...
func (m *QueryFinalizedChainInfoResponse) GetNextValidatorSet() []*types1.ValidatorWithBlsKey {
	if m != nil {
...
var fileDescriptor_2caab7ee15063236 = []byte{
	...
	,
}
...
func (m *QueryFinalizedChainInfoResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.NextValidatorSet = append(m.NextValidatorSet, &types1.ValidatorWithBlsKey{})
