...
type FinalizedChainData struct {
...
func (m *FinalizedChainData) Reset()         { *m = FinalizedChainData{} }
func (m *FinalizedChainData) String() string { return proto.CompactTextString(m) }
func (*FinalizedChainData) ProtoMessage()    {}
func (*FinalizedChainData) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd665af90102da38, []int{13}
}
func (m *FinalizedChainData) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FinalizedChainData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FinalizedChainData.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FinalizedChainData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FinalizedChainData.Merge(m, src)
}
func (m *FinalizedChainData) XXX_Size() int {
	return m.Size()
}
func (m *FinalizedChainData) XXX_DiscardUnknown() {
	xxx_messageInfo_FinalizedChainData.DiscardUnknown(m)
}

var xxx_messageInfo_FinalizedChainData proto.InternalMessageInfo

func (m *FinalizedChainData) GetFinalizedChainInfo() *ChainInfo {
	if m != nil {
...
func (m *FinalizedChainData) GetEpochInfo() *types.Epoch {
	if m != nil {
		return m.EpochInfo
	}
	return nil
...
func (m *FinalizedChainData) GetRawCheckpoint() *types1.RawCheckpoint {
	if m != nil {
...
func (m *FinalizedChainData) GetBtcSubmissionKey() *types2.SubmissionKey {
	if m != nil {
...
func (m *FinalizedChainData) GetProof() *ProofFinalizedChainInfo {
	if m != nil {
		return m.Proof
	}
	return nil
...
type FinalizedChainInfoResponse struct {
	ChainId            string              `protobuf:"bytes,1,opt,name=chain_id,json=chainId,proto3" json:"chain_id,omitempty"`
	FinalizedChainInfo *FinalizedChainData `protobuf:"bytes,2,opt,name=finalized_chain_info,json=finalizedChainInfo,proto3" json:"finalized_chain_info,omitempty"`
}

func (m *FinalizedChainInfoResponse) Reset()         { *m = FinalizedChainInfoResponse{} }
func (m *FinalizedChainInfoResponse) String() string { return proto.CompactTextString(m) }
func (*FinalizedChainInfoResponse) ProtoMessage()    {}
func (*FinalizedChainInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd665af90102da38, []int{14}
}
func (m *FinalizedChainInfoResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FinalizedChainInfoResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FinalizedChainInfoResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FinalizedChainInfoResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FinalizedChainInfoResponse.Merge(m, src)
}
func (m *FinalizedChainInfoResponse) XXX_Size() int {
	return m.Size()
}
func (m *FinalizedChainInfoResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_FinalizedChainInfoResponse.DiscardUnknown(m)
}

var xxx_messageInfo_FinalizedChainInfoResponse proto.InternalMessageInfo

func (m *FinalizedChainInfoResponse) GetChainId() string {
	if m != nil {
		return m.ChainId
	}
	return ""
...
func (m *FinalizedChainInfoResponse) GetFinalizedChainInfo() *FinalizedChainData {
	if m != nil {
		return m.FinalizedChainInfo
	}
	return nil
...
type QueryFinalizedChainsInfoResponse struct {
	Data []*FinalizedChainInfoResponse `protobuf:"bytes,1,rep,name=data,proto3" json:"data,omitempty"`
}
...
func (m *QueryFinalizedChainsInfoResponse) GetData() []*FinalizedChainInfoResponse {
	if m != nil {
		return m.Data
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*FinalizedChainData)(nil), "babylon.zoneconcierge.v1.FinalizedChainData")
	proto.RegisterType((*FinalizedChainInfoResponse)(nil), "babylon.zoneconcierge.v1.FinalizedChainInfoResponse")
...
var fileDescriptor_cd665af90102da38 = []byte{
	...
	,
}
...
func (m *FinalizedChainData) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FinalizedChainData) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FinalizedChainData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *FinalizedChainInfoResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FinalizedChainInfoResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FinalizedChainInfoResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *FinalizedChainData) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FinalizedChainInfoResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FinalizedChainData) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FinalizedChainData: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FinalizedChainData: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *FinalizedChainInfoResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FinalizedChainInfoResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FinalizedChainInfoResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			if m.FinalizedChainInfo == nil {
				m.FinalizedChainInfo = &FinalizedChainData{}
			}
			if err := m.FinalizedChainInfo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *QueryFinalizedChainsInfoResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Data = append(m.Data, &FinalizedChainInfoResponse{})
