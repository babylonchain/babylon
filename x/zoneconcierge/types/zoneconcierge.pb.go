...
type ProofFinalizedChainInfo struct {
	...
	EpochInfo *types2.Epoch `protobuf:"bytes,2,opt,name=epoch_info,json=epochInfo,proto3" json:"epoch_info,omitempty"`
	...
	BtcSubmissionKey *types3.SubmissionKey `protobuf:"bytes,4,opt,name=btc_submission_key,json=btcSubmissionKey,proto3" json:"btc_submission_key,omitempty"`
	// proof_tx_in_block is the proof that tx that carries the header is included in a certain Babylon block
	ProofTxInBlock *types.TxProof `protobuf:"bytes,5,opt,name=proof_tx_in_block,json=proofTxInBlock,proto3" json:"proof_tx_in_block,omitempty"`
	...
	ProofEpochSubmitted []*types3.TransactionInfo `protobuf:"bytes,8,rep,name=proof_epoch_submitted,json=proofEpochSubmitted,proto3" json:"proof_epoch_submitted,omitempty"`
}
...
var fileDescriptor_c76d28ce8dde4532 = []byte{
	...
	,
}
